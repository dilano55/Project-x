...
screen = ui.Canvas(window, width= 400, height= 150, bg="black",bd=0,highlightthickness = 0)
screen.pack()
#variables:_START
amount_kids = 0
amount_beds = 0
#widgets_1_START
text2 = ui.Label(screen, text='Amount of children?',fg= "white", bg="black", font=("arial", 20), width = 15)
text3 = ui.Label(screen, text='Amount of beds?',fg= "white", bg="black", font=("arial", 20), width = 15)
